...
function gameLoop(delta, airball, direcao) {
    switch (direcao) {
        ...
        if(colisao(player, airball)) {
            app.stage.removeChild(airball);
            if(airball.cont == 0 && airball.hitMark == 1) { console.log('hit!'); airball.cont++; }
        }
}
